...
本編⑱⑲ ドラフト添削処理 → ⑳…
  ↓
第二の脳 未着手 1 本（音声メモ＝塊2-F 統合）or 塊2 残り（E / A / C）着手
```
...
- **塊2（外出し小ネタ候補・2026-05-20 整理後）**: E 設計シンプル運用複雑 / A 見落とし / C ダッシュボード（独立単発、シリーズ外）。~~B 掟~~・~~D 引越し大工事~~ はボツ判定、~~F 音声メモ~~ は第二の脳「音声メモ格納」に統合
