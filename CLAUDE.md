...
|---|---------|------|
| (1)〜(12) | リライト済み | 公開済み |
| (13) | Claude Codeで開発が変わった | 2026-04-16公開 |
| (14) | オフ会の仕組みを作れた | パイプライン通過・公開待ち |
| (15) | 地図を出せた | パイプライン通過・公開待ち |
| (16) | 誰も来ないサイトを分析してる | パイプライン通過・公開待ち |
| (17) | AIと認知戦略を練ってる | パイプライン通過・公開待ち |
| (18) | UIで印象が変わると知った（旧17 PC/モバイル） | ドラフト・添削待ち |
| (19) | APIの請求額に震えた（旧18） | ドラフト・添削待ち |
| 番外(1)(2) | — | 公開済み |
| 番外(3) | 自己紹介編 | 2026-04-15公開 |
| 番外(4) | 言葉の意味も分からず開発を進めてた話 | パイプライン通過・公開待ち |

### シーズン構造
- **シーズン1** (1)〜(6): 概念編（AI使い分け、考え方、壁打ち）— 公開済み
- **シーズン2** (7)〜(15): 実装編（土台→メイン機能→地図完成）
- **シーズン3** (16)〜: 届ける編（公開後の認知・集客・運用）
- **番外編**: (1)(2)(3) 公開済み、(4) 用語集はシーズン2→3 の橋渡し位置
