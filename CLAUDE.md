...
| (14) | オフ会の仕組みを作った | 公開済み |
| (15) | 地図を出せた | 公開済み |
| (16) | 誰も来ないサイトを分析してる | Published-Current済・公開待ち |
| (17) | AIと認知戦略を練ってる | Published-Current済・公開待ち |
...
|---|---------|------|
| 番外(1)(2)(3) | — | 公開済み |
| 番外(4) | 言葉の意味も分からず開発を進めてた話（用語集） | Published-Current済・公開待ち（⑮⑯の間挿入予定） |
| 番外(5) | ロードスターMTG終了のニュースを受けて | Published-Current済・明後日以降公開（緊急対応、2026-04-24完成） |

**特別編:**
| # | タイトル | 状態 |
|---|---------|------|
| ①②③ | — | 公開済み |
| ④ | AIの使い道は探すほど見つからない | note下書き登録済・2026-04-24公開予定 |
| ⑤ | AI活用の仕組み作りにAIを使う | Published-Current済・note下書き配置予定 |

### シーズン構造
- **シーズン1** (1)〜(6): 概念編（AI使い分け、考え方、壁打ち）— 公開済み
- **シーズン2** (7)〜(15): 実装編（土台→メイン機能→地図完成）— 公開済み
- **シーズン3** (16)〜: 届ける編（公開後の認知・集客・運用・セキュリティ）
- **番外編**: (1)(2)(3) 公開済み、(4) 用語集はシーズン2→3 の橋渡し位置、(5) 緊急対応で不定位置
- **特別編**: ①②③ 公開済み、④⑤ 公開待ち。AI活用術系の独立単発

### 公開待ち直近キュー
```
特別編④(2026-04-24) → ⑤(下書き配置) → 本編⑯ → ⑰ → 番外(4)用語集 → 緊急番外(5) → 本編⑱⑲ → ⑳㉑㉒…
```
